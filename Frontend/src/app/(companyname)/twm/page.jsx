...
import TWMHeader from "@/components/twm/TWMHeader"
import TWMStats from "@/components/twm/TWMStats"
import TWMTable from "@/components/twm/TWMTable"
...
export default function ThreeWayMatchPage() {
    ...
    const loadRecords = useCallback(async (search = "", filters = {}, showRefresh = false) => {
        ...
        try {
            const { records: fetched, pagination: pag } = await fetchTWMList({
    ...
    useEffect(() => {
        ...
        loadRecords(searchRef.current, filtersRef.current, true)
    }, [projectId])
