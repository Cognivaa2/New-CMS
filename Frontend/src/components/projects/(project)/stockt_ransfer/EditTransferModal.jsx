...
import { Backdrop, TransferFormContentEdit } from "./TransferFormFields"
      ...
      items:
        transfer.items?.length > 0
          ? transfer.items.map((item) => ({
              ...
              materialMasterId: String(item.materialMasterId || ""),
          ...
          : [
              {
                inventoryId: "", materialMasterId: "",
                materialName: "", unit: "Units",
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm font-sfpro-medium text-gray-500 dark:text-[#71717a] mt-1">
                {transfer?.status === "Rejected"
                  ? "This transfer was rejected — editing will reset it to Draft"
