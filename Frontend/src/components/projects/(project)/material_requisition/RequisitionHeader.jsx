...
const MR_FILTERS = [
  {
    ...
    options: [
      ...
      { value: "ConvertedToPO", label: "Converted to PO" },
    ],
  },
  {
    key: "sortBy",
    ...
    options: [
      ...
      { value: "mrNumber",       label: "MR Number" },
      { value: "requiredByDate", label: "Required By Date" },
    ],
  },
  {
    key: "order",
    ...
    <div className="relative z-20 flex flex-col lg:flex-row lg:items-end justify-between gap-6 w-full mb-8 font-sfpro transition-all duration-300">
      <div className="flex-1 min-w-0">
        ...
        <p className="text-[13.5px] sm:text-[14.5px] text-gray-400 dark:text-gray-500 mt-3 max-w-lg leading-relaxed">
          {description || "Manage and track material requests for your project"}
        </p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 w-full lg:w-auto">
        <div className="relative w-full sm:w-[320px] lg:w-75">
          ...
          <input
            type="text"
            placeholder="Search by MR number or material..."
            value={searchValue}
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          <div className="flex-1 sm:flex-initial">
            <Tooltip content="Create a new material requisition" side="left">
              <button
                onClick={onAction}
              ...
              >
                ...
                <span className="truncate">Create MR</span>
              </button>
            </Tooltip>
          </div>
        </div>
