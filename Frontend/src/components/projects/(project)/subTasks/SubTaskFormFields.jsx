...
export function Field({ label, placeholder, colSpan, value, onChange, disabled, required, type = "text", min, max }) {
    return (
...
export function TextArea({ label, placeholder, colSpan, value, onChange, disabled }) {
    return (
        <div className={colSpan}>
            <div className="text-xs lg:text-sm font-sfpro text-black dark:text-white mb-1.5 transition-colors">
                {label}
...
export function SubTaskFormContentAdd({
    form,
    setForm,
    projectUsers = [],
    isLoadingUsers = false,
    disabled = false,
    taskStartDate = null, // ← Add this
    taskEndDate = null, // ← Add this
}) {
        ...
        <div className="flex-1 overflow-y-auto px-8 lg:px-20 xl:px-36 pt-7 space-y-8 pb-25" style={{ scrollbarWidth: "none" }}>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-5">
                <Field
                    ...
                    placeholder="Install rebar grid"
                    colSpan="col-span-2"
                    value={form.title}
                ...
                <DatePickerField
                    ...
                    minDate={taskStartDate} // ← Add this
                    maxDate={taskEndDate} // ← Add this
                />
                <DatePickerField
                    label="End Date"
                    colSpan="col-span-1 md:col-span-1"
                ...
                <TextArea
                    label="Description"
                    placeholder="Briefly describe what this sub task involves…"
...
export function SubTaskFormContentEdit({
    form,
    setForm,
    disabled = false,
    taskStartDate = null, // ← Add this
