    ...
    const modal = (
        ...
        >
            <div className="flex items-center justify-between px-2.5 pt-1.5 pb-2 mb-0.5">
                <p className="text-sm font-sfpro-medium text-[#212121] dark:text-white">Phase Members</p>
                    ...
                    <div className="flex flex-col items-center justify-center py-6 gap-2 text-center px-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs font-sfpro text-[#a1a1aa] dark:text-[#71717a] mt-0.5">
                                No users assigned to tasks in this phase
                            </p>
                        </div>
                    </div>
                ) : (
                    users.map((user) => (
                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                <p className="text-sm font-sfpro-medium text-[#212121] dark:text-[#f4f4f5] truncate leading-tight">
                                    {user.name}
                                </p>
                                {user.email && (
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-1 w-full lg:w-auto">
                    ...
                    <div className="flex items-center gap-1 w-full sm:w-auto">
                        ...
                        <div className="flex-1 sm:flex-initial">
                            <Tooltip content="Create a new task" side="left">
                                <button
                                    onClick={onOpenAdd}
