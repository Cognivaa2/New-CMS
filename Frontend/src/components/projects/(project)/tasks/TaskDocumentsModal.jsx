...
import { fetchTaskDocuments, debounce } from "@/app/(companyname)/projects/[projectId]/phases/[phaseId]/api"
...
export default function TaskDocumentsModal({ isOpen, onClose, task, phaseId, projectId }) {
  ...
  useEffect(() => {
    if (!isOpen || !phaseId || !taskId) return
  ...
  }, [isOpen, phaseId, taskId, currentPage, debouncedQuery])
  ...
  const handleViewDoc = useCallback(
    (doc) => {
      setViewerDoc({ ...doc, phaseId, taskId, projectId })
      setIsViewerOpen(true)
    },
    [phaseId, taskId, projectId]
  )
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
        ...
        >
          ...
          <div className="px-6 pb-5 mt-2">
            ...
            <p className="text-sm text-gray-500 dark:text-[#8d8d8d] mt-1 font-sfpro">
              {task?.taskName || "View and manage documents linked to this task"}
            </p>
          </div>
