...
import { Search, X, Loader2, GitCompare } from "lucide-react"
...
const TWM_FILTERS = [
    ...
    },
    {
        ...
        options: [
            ...
            { value: "totalOrderValue", label: "Order Value" },
        ],
    },
    {
        key: "order",
...
export default function TWMHeader({
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-5 w-full mb-8 font-sfpro transition-colors duration-300">
            <div className="min-w-0">
                ...
                <p className="text-[13px] sm:text-[14px] text-[#a3a3a3] dark:text-[#71717a] mt-3 max-w-full sm:max-w-105 leading-snug transition-colors">
                    {description || "Compare PO, GRN, and Invoice data to identify discrepancies and ensure accurate reconciliation"}
                </p>
            </div>
