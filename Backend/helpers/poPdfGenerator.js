...
export async function generatePOPdf(res, { po, company, vendor, project, createdByUser }) {
    ...
    absText(doc, po.poNumber, MX + CW * 0.6, y + 2, {
    ...
    y = label(doc, y, "Order Information");
    y = twoColGrid(doc, y, [
        ["Expected Delivery", fmt(po.expectedDeliveryDate)],
    ...
    ["Prepared By", "Verified By", "Approved By"].forEach((lbl, s) => {
